        ...
        <div className="p-6">
            ...
            <div className="mb-6 flex items-center justify-between">
                ...
                <select
                    ...
                    className="ml-4 rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-1 focus:ring-blue-600 outline-none sm:text-sm sm:leading-6"
                >
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow">
                <ul role="list" className="divide-y divide-gray-200">
                    {filteredComplaints?.map((complaint) => (
                        <li key={complaint._id} className="p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => updateComplaintStatus(complaint._id, e.target.value as Complaint['status'])}
